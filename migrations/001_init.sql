...
CREATE TABLE buses (
  ...
  bus_type VARCHAR(50) NOT NULL CHECK (
    bus_type IN (
      'AC Sleeper',
      'Non-AC Sleeper',
      'AC Seater',
...
CREATE TABLE bookings (
  ...
  status VARCHAR(15) NOT NULL DEFAULT 'confirmed' CHECK (status IN ('confirmed', 'cancelled', 'pending')),
...
CREATE TABLE booking_seats (
  ...
  passenger_age INT NOT NULL CHECK (
    passenger_age > 0
    AND passenger_age < 120
  ),
...
VALUES (
    ...
    'admin@redbus.com',
    '9999999999',
    '$2b$12$NQNxeOnkWHekqpvgww.5oesBjx2k9YOQpkqq4rpIlkJmix57tm.bi',
    'admin'
  );
-- Buses
INSERT INTO buses (
...
dpc INT;
BEGIN
SELECT COUNT(*) INTO bc
FROM buses;
SELECT COUNT(*) INTO tc
FROM trips;
SELECT COUNT(*) INTO uc
FROM users;
SELECT COUNT(*) INTO bpc
FROM boarding_points;
SELECT COUNT(*) INTO dpc
...
RAISE NOTICE '   Trips:           %',
tc;
RAISE NOTICE '   Boarding points: %',
bpc;
RAISE NOTICE '   Dropping points: %',
dpc;
RAISE NOTICE '   Users:           %',
uc;
